...
class _EditPlaceScreenState extends State<EditPlaceScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await context.read<PlaceManager>().updatePlace(_placeData);
      ...
      Navigator.of(context).pop();
      Navigator.of(context).push(CustomPageRoute(page: PlaceDetailScreen(), arguments:{'placeId': _placeData['id']} ));
